...
class PickupSelectorScreen extends Component {
      ...
      <View style={styles.container}>
        <View style={styles.wrapper}>
          <ScrollView style={styles.regis__form}>
            <Text style={styles.regis__sub_message}>Pickup Information</Text>
            <View style={styles.regis__form_control}>
              <Text style={styles.regis__label}>
                Date Time <Text style={styles.red}>*</Text>
              </Text>
              <TextInput style={styles.regis__field} placeholder="Please select date and time" />
            </View>
            <View style={styles.regis__form_control}>
              <Text style={styles.regis__label}>
                Branch <Text style={styles.red}>*</Text>
              </Text>
              <TextInput style={styles.regis__field} placeholder="Please select branch" />
            </View>
            {/* 
            <Text style={[styles.regis__sub_message, { marginTop: 20 }]}>Tax Invoice Address</Text>
            <View style={styles.regis__form_control}>
              <Text style={styles.regis__label}>
                Nationality ID <Text style={styles.red}>*</Text>
              </Text>
              <TextInput style={styles.regis__field} placeholder="Nationality ID" />
            </View>
...
export default PickupSelectorScreen;
